...
We should now be able to do an inverse Fourier transform. We can once we approximate $\abs{\bm{k}} \approx \frac{\bm{q}_n}{\abs{\bm{q}_n}} \cdot \bm{k}$. Then we obtain
\begin{align}
