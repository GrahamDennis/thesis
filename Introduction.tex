...
Single-mode operation is not simply desirable for an atom laser, it is necessary.  Due to the significant interatomic interactions, multiple lasing modes in an atom laser could not operate independently.  Significant scattering would occur between the lasing modes increasing the linewidth of both, possibly destroying any laser-like qualities in the process.  While the interatomic interactions can be `switched off' with the use of a Feschbach resonance, the loss process are such that the higher energy modes experience \emph{less} loss than the lower modes in this case \citep{Haine:2002kp}.  The question of gain is a separate one.  In \citeauthor{Haine:2002kp}'s model, the gain was mode-independent.  

Due to the significant atomic scattering interactions, multiple lasing modes in an atom laser could not operate independently.  

 nonlinear scattering interactions between atoms, multiple lasing modes 



The dispersion relations (the expression for energy --- or equivalently, frequency --- as a function of wavenumber) of these two reservoirs are such that pumping an atom laser using either is fundamentally more difficult than pumping a photon laser.





The dispersion relations of these two reservoirs are such that pumping an atom laser using either is fundamentally more difficult than pumping a photon laser.  In a photon laser, the dispersion relation of its reservoir (the atomic modes) is relatively flat by comparison to that of the lasing mode.  For example, the dispersion curve for 

Whey do we care about dispersion relations?  This needs to be explained.


There is a fundamental difficulty associated with pumping an atom laser


It is fundamentally more difficult to pump an atom laser using mechanisms

There is a fundamental difficulty in pumping 



Now we have a discussion of dispersion relations.  And the feasibility of each of these pumping processes.  This leads into a discussion of `homogeneous broadening' and `inhomogeneous broadening' in the context of atom lasers.


is discussed in further detail in \sectionref{OpticalPumping:PumpingMechanism}.


There are two choices of reservoir for the pumping mechanism of an atom laser: the empty modes of the atomic field, or the empty modes of the optical field.  Each choice corresponds to a different class of pumping mechanism.  In the first, an atom in an excited internal state is brought near the lasing mode into which it is stimulated to emit.  The emitted photon 



Irreversibility leads into homogeneous vs inhomogeneous broadening, and then we can discuss single-mode operation?

Each of these choices results in a different 
...
In a continuously pumped atom laser, single-mode operation is not only desirable, it is necessary.  Due to the interatomic interactions, were two lasing modes to exist, they would undergo scattering and bad stuff would happen.


In a continuously pumped atom laser, we desire both gain-narrowing and single-mode operation.  Single-mode operation is essential in an atom laser unless the interatomic interactions are made negligible through the use of a Feschbach resonance, as the scattering interactions between two lasing modes would mean that they could not operate independently.  The interactions between the two modes that experience gain would lead to an increase in the linewidth of both of the modes, and general badness.
...
The difference between the atom laser and the optical laser is about dispersion relations for the available reservoirs.


In an atom laser, we want gain-narrowing and single-mode operation.  Without gain-narrowing, the linewidth is limited by the outcoupling rate in the same way as if the 



Issues to discuss: linewidth, gain-narrowing, irreversibility, single-mode operation.



For a pumping mechanism 
...
a finite number of excitations which can 

Typically a pumping mechanism is 

the lasing mode cannot be forever amplified


Gain-narrowing is caused by the saturation of the pumping process; while small signals can be exponentially amplified by a pumping mechanism

.  The linewidth of this emitted light is limited by the linewidth of the optical cavity.  



Without a pumping mechanism, an optical laser is simply a leaky cavity emitting an exponentially decreasing amount of light.  The linewidth of this emitted light is limited by the linewidth of the optical cavity.  The pumping mechanism for an optical laser not only permits continuous operation of the laser, but it also narrows the linewidth of the laser in a process known as \emph{gain-narrowing}.  Gain-narrowing is caused by the saturation of the pumping process, and although the pumping process does not need to be saturable for the output of the laser to be coherent (or to have many of the other properties typically associated with a laser \citep{Wiseman:1997ba}), a narrow linewidth is critical for the optical laser in many interferometry applications.  

Need to talk about saturation.  This is important because it affects the results of previous atom laser pumping models.  Classify past atom laser pumping papers.
