...
\begin{figure}
    ...
    \caption{FIXME: This is not a caption. Values: $\Omega_{\text{A} \leftrightarrow \text{E}}(-\infty) = 1.5 \times \unit[10^8]{s\textsuperscript{-1}}$, $\Delta = 10^3 \Gamma = 2 \pi \times \unit[5.9]{GHz}$, $\Omega_\text{Raman} = 1 \times \unit[10^2]{s\textsuperscript{-1}}$.  Steady-state efficiencies achieved: (a) 48\%, (b) 19\%.  There is an absorbing boundary reducing the density of the atom laser in both, but this is observed in (b).}
...
\begin{figure}
    ...
    \caption{FIXME: This is not a caption.  Only the levels which have not been greyed out are included in this model.  Of course all the excited levels have been adiabatically eliminated.}
    \label{OpticalPumping:3LevelModelLevelDiagram}
\end{figure}

Throw the equations out there, then we explain how the 1D reduction is made.
\begin{subequations}
    \begin{align}
        \begin{split}
        ...
        \begin{split}
            ...
            &\relphantom{=} + \hbar \Omega_\text{RF} \Psi_{2, 2}  - i \hbar \,Q({2, 0 \xrightarrow{\pi,\pi} 2, 0}) \abs{E_\pi}^2 \Psi_{2, 0} - i \hbar \,Q(2, 0 \xrightarrow{\pi,\sigma^+} 1, -1) E_\pi^* E_{\pislash}^{\phantom{*}} \Psi_{1, -1}
        \end{split}\\
        \begin{split}
            ...
            &\relphantom{=} - i \hbar \,Q(1, -1 \xrightarrow{\sigma^+,\sigma^+} 1, -1) \abs{E_{\pislash}}^2 \Psi_{1, -1} - i \hbar \,Q(1, -1 \xrightarrow{\sigma^+,\pi} 2, 0) E_{\pislash}^* E_\pi^{\phantom{*}}\Psi_{2, 0}
        \end{split}
    \end{align}
\end{subequations}
where $E_\pislash$ is the electric field in the polarisation orthogonal to $\pi$.  $\unitvec{u}_\pi = \unitvec{z}$, $\unitvec{u}_\pislash = \unitvec{x}$, $\unitvec{u}_{\sigma^{\pm}} = \frac{1}{\sqrt{2}} \left(\unitvec{x} \pm i \unitvec{y}\right)$
...
The electric fields are split as
\begin{align}
    E_{i}(y) &= E_{i, \text{up}}(y) + E_{i, \text{down}}(y)
\end{align}
and evolve as
\begin{subequations}
    \begin{align}
        \begin{split}
            \frac{\partial}{\partial y}E_{\pi, \text{up}} &= i k E_{\pi, \text{up}} - \frac{\hbar k}{2 \varepsilon_0 A_\perp} Q({2, 0 \xrightarrow{\pi,\sigma^+} 1, -1}) \Psi_{2, 0}^* \Psi_{1, -1} E_{\pislash}\\
        ...
        \end{split}\\
        \begin{split}
            -\frac{\partial}{\partial y}E_{\pi, \text{down}} &= i k E_{\pi, \text{down}} - \frac{\hbar k}{2 \varepsilon_0 A_\perp} Q({2, 0 \xrightarrow{\pi,\sigma^+} 1, -1}) \Psi_{2, 0}^* \Psi_{1, -1} E_{\pislash}\\
        ...
        \end{split}\\
        \begin{split}
            \frac{\partial}{\partial y}E_{\pislash, \text{up}} &= i k E_{\pislash, \text{up}} - \frac{\hbar k}{2 \varepsilon_0 A_\perp} Q({2, 0 \xrightarrow{\pi,\sigma^+} 1, -1}) \Psi_{1, -1}^* \Psi_{2, 0} E_{\pi} \\
            &\relphantom{=} - \frac{\hbar k}{2 \varepsilon_0 A_\perp} Q({1, -1 \xrightarrow{\sigma^+,\sigma^+} 1, -1}) \abs{\Psi_{1, -1}}^2 E_{\pislash, \text{up}} 
        \end{split}\\
        \begin{split}
            -\frac{\partial}{\partial y}E_{\pislash, \text{down}} &= i k E_{\pislash, \text{down}} - \frac{\hbar k}{2 \varepsilon_0 A_\perp} Q({2, 0 \xrightarrow{\pi,\sigma^+} 1, -1}) \Psi_{1, -1}^* \Psi_{2, 0} E_{\pi} \\
            &\relphantom{=} - \frac{\hbar k}{2 \varepsilon_0 A_\perp} Q({1, -1 \xrightarrow{\sigma^+,\sigma^+} 1, -1}) \abs{\Psi_{1, -1}}^2 E_{\pislash, \text{down}} 
        \end{split}
\end{align}
\end{subequations}
