...
\usepackage{url}
\usepackage[pdftex,bookmarks,colorlinks,breaklinks,pdfauthor=Graham Russell Dennis,pdftitle=Untitled Thesis \#1,final]{hyperref}  % PDF hyperlinks, with coloured links
...
\newcommand{\parasep}{\begin{center} \includegraphics[scale=0.5]{HRule} \end{center}}
...
% \begin{dedication}
% To the principle of conservation of badness: may it be disproven one day.
% \end{dedication}
...
\include{TransverseProfile}

\include{Peaks}

\include{OpticalPumping}

\include{KineticTheory}

%\include{Conclusion}
\appendix
\include{FloquetAppendix}
\include{PenningIonisationAppendix}
\include{MethodsAppendix}
\include{ToolsAppendix}
