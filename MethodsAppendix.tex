...
\section{Collision and energy-redistribution in Quantum Kinetic Theory}
\label{MethodsAppendix:QKTOtherTerms}
Here we give the forms of the relevant terms in \eqref{KineticTheory:EvolutionEquations}. We omit derivations as they are given in \citep{Bijlsma:2000,Proukakis:2008}.


\section{Three-body loss in Quantum Kinetic Theory}
\label{MethodsAppendix:QKT3BodyLoss}
As this derivation was not performed by myself, I will relegate it to an appendix. Here may it rest in peace. The following derivation was performed by \emph{Matthew Davis}.
