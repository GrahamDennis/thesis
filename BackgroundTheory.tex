...
First consider transmission through the absorbing boundary layer. In a reference frame co-moving with the incident wave\footnote{The details of such transformations and their utility are discussed in more detail in \sectionref{TransverseProfile:DropGP}.}, the Schrödinger equation (and the GP equation in the absence of interactions) takes the form
\begin{align}
