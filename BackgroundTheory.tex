...
The good agreement between the Truncated Wigner and exact results in \figureref{BackgroundTheory:TwoTimeTWComparison} for $\kappa t \lesssim \frac{\pi}{}$ does not mean that the distributions themselves are approximately equal over this time.  The Wigner and Truncated Wigner distributions for the anharmonic oscillator are illustrated in \figureref{BackgroundTheory:WignerTruncatedWignerComparison}.
...
% Don't forget to cite that crazy Russian who showed that TW is the second term in an expansion in the evolution.
