...
FIXME: This chapter contains results published in ... \citep{Dall:2007} Jeppesen too?
...
The Gross-Pitaevskii equation has been a tremendously successful description of Bose-condensed systems, and has been used to successfully describe \dots\footnote{FIXME: Cite stuff.}   The nonlinear term of the GP equation prevents it being solved analytically, however it is tractable to solve numerically.  The following section describes a limit in which the approximate form of the ground state of the GP equation may be obtained.
...
The expansion is in terms of a gaussian state at the level of Bog, HF, HFB, etc.  If higher-order terms were included, this would not necessarily be the case, however as it is typically used, it is a more restricted version of stuff..  This means that the Wigner function is also Gaussian.  
