...
% FIXME: Something about the anomaly of the experimental data that needs investigating.  Calculate the transmission probability for a photon at 12 MHz detuning.  Note that the model includes absorption and subsequent re-emission in the same direction, it is only scattering that has been neglected (and re-scattering).
