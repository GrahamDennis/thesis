...
\newcommand{\ketbra}[2]{\ensuremath{\left|#1\right>\!\!\left<#2\right|}}
...
\begin{titlepage}
\title{\textbf{\relsize{2}Untitled Thesis \#1}\\[2cm]
        or: \emph{\relsize{2}Random Things I Did During My PhD at ANU.}}
