...
Rotate as $\Psi_{i} = \widetilde{\Psi}_i e^{-i (\omega_i - \Delta_i)t}$, $\Psi_{i'} = \widetilde{\Psi}_{i'} e^{-i (\omega_{i'} - \Delta_{i'})t}$, $E_{+,\bm{q}_n} = \widetilde{E}_{+, \bm{q}_n} e^{-i \omega_{\bm{q}_n}t}$.
