...
Joe believes the best way forward is to tie down my intro and conclusion and then go from there.  Or perhaps equivalently, to write out dot points for each section to help keep me on track during the writing process.  At this level I would need to decide what was in and what was out.
...
\begin{figure}
    ...
    \caption{FIXME: This is not a caption. \label{OpticalPumping:LambdaModel}}
\end{figure}
